(function (root, factory) {
  if (typeof define === 'function' && define.amd)
    define(['exports', 'kotlin', 'kotlin-wrappers-kotlin-react-dom-jsLegacy', 'kotlinx-coroutines-core', 'kotlin-wrappers-kotlin-react-jsLegacy', 'kotlin-css', 'kotlin-wrappers-kotlin-styled-jsLegacy', 'kotlinx-html-js', 'react-share', 'react-youtube-lite'], factory);
  else if (typeof exports === 'object')
    factory(module.exports, require('kotlin'), require('kotlin-wrappers-kotlin-react-dom-jsLegacy'), require('kotlinx-coroutines-core'), require('kotlin-wrappers-kotlin-react-jsLegacy'), require('kotlin-css'), require('kotlin-wrappers-kotlin-styled-jsLegacy'), require('kotlinx-html-js'), require('react-share'), require('react-youtube-lite'));
  else {
    ...
    }root.confexplorer = factory(typeof confexplorer === 'undefined' ? {} : confexplorer, kotlin, this['kotlin-wrappers-kotlin-react-dom-jsLegacy'], this['kotlinx-coroutines-core'], this['kotlin-wrappers-kotlin-react-jsLegacy'], this['kotlin-css'], this['kotlin-wrappers-kotlin-styled-jsLegacy'], this['kotlinx-html-js'], this['react-share'], this['react-youtube-lite']);
  }
}(this, function (_, Kotlin, $module$kotlin_wrappers_kotlin_react_dom_jsLegacy, $module$kotlinx_coroutines_core, $module$kotlin_wrappers_kotlin_react_jsLegacy, $module$kotlin_css, $module$kotlin_wrappers_kotlin_styled_jsLegacy, $module$kotlinx_html_js, $module$react_share, $module$react_youtube_lite) {
  'use strict';
  ...
  function KotlinVideo(id, title, speaker, videoUrl) {
    this.id_23vhzt$_0 = id;
    this.title_7ywm62$_0 = title;
    this.speaker_gx1z0t$_0 = speaker;
    this.videoUrl_nqnbe6$_0 = videoUrl;
  }
  Object.defineProperty(KotlinVideo.prototype, 'id', {
    get: function () {
      return this.id_23vhzt$_0;
    }
  });
  Object.defineProperty(KotlinVideo.prototype, 'title', {
    get: function () {
      return this.title_7ywm62$_0;
    }
  });
  Object.defineProperty(KotlinVideo.prototype, 'speaker', {
    get: function () {
      return this.speaker_gx1z0t$_0;
    }
  });
  Object.defineProperty(KotlinVideo.prototype, 'videoUrl', {
    get: function () {
      return this.videoUrl_nqnbe6$_0;
    }
  });
  ...
  package$components.VideoList = VideoList;
  package$components.videoList_9yl09l$ = videoList;
  package$components.VideoPlayer = VideoPlayer;
  package$components.videoPlayer_dehla4$ = videoPlayer;
  var package$data = _.data || (_.data = {});
  package$data.KotlinVideo = KotlinVideo;
  var package$util = _.util || (_.util = {});
  package$util.fetchVideo_za3lpa$ = fetchVideo;
  package$util.fetchVideos = fetchVideos;
  main();
